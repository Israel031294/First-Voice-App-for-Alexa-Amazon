...
module.exports = {
    ...
    es: {
        translation: {
            SKILL_NAME: 'Curiosidades historicas',
            GET_FACT_MESSAGE: 'Aquí está tu curiosidad: ',
            HELP_MESSAGE: 'Puedes decir dime una curiosidad historica o puedes decir salir... Cómo te puedo ayudar?',
            HELP_REPROMPT: 'Como te puedo ayudar?',
            FALLBACK_MESSAGE: 'La skill Curiosidades historicas no te puede ayudar con eso.  Te puede ayudar a descubrir curiosidades sobre ls historia si dices dime una curiosidad historica. Como te puedo ayudar?',
            FALLBACK_REPROMPT: 'Como te puedo ayudar?',
            ERROR_MESSAGE: 'Lo sentimos, se ha producido un error.',
            STOP_MESSAGE: 'Adiós!',
            FACTS:
                [
                'en 1820 todo un pueblo organizó un juicio contra los jitomates',
                'el nombre real de miguel hidalgo es miguel gregorio antonio ignacio hidalgo y costilla',
                'pedro lascuráin solo duro 45 minutos en el poder',
                'little boy es el nombre de una bomba usada en la segunda guerra mundial',
                'Miguel hidalgo murio al año de iniciada la independecia',
                'el papa Gregorio IX básicamente le declaró la guerra a los gatos del mundo',
                'En 1923, un jinete murió a mitad de una carrera, ¡y aún así ganó',
                ],
        }
    },
    de: {
